...
[DeepWiki Docs](https://deepwiki.com/finch-xu/GetCat) · [Official Site](https://getcat.io/)
...
- **Variables & pre/post operations**: global / category / environment scopes with `{{var}}` and `{{$timestamp}}`; set variables before sending, extract response fields and assert afterwards — no scripting; Postman environment import/export.
